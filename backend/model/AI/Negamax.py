...
class Negamax(AI):
    """
    Represents a Connect Four AI using the Negamax algorithm.
    ...
    def play(self, board: Board) -> int:
        """
        Choose the best column using Negamax with alpha-beta pruning.
        """
    ...
    def _has_won(bitboard: int) -> bool:
        for shift in (1, Negamax.STRIDE, Negamax.STRIDE - 1, Negamax.STRIDE + 1):
